...
export default function LoginPage() {
  return (
    <div className="min-h-screen w-full bg-[#eee9e0] relative overflow-x-hidden overflow-y-auto flex items-center justify-center font-sans selection:bg-[#d9cbb8]/50">
      
      {/* Background Texture Overlay (Subtle Grain) */}
      <div 
        className="fixed inset-0 opacity-60 mix-blend-multiply pointer-events-none z-0" 
      ...
      <div className="relative w-full max-w-[1600px] min-h-screen flex flex-col lg:flex-row items-center lg:justify-between py-12 px-4 lg:p-12 z-10 gap-4 sm:gap-8 lg:gap-32">
        
        {/* ======================= */}
        {/* LEFT SIDE: SCRAPBOOK COLLAGE */}
        {/* ======================= */}
        <div className="w-full lg:w-[55%] h-[300px] sm:h-[500px] lg:h-[900px] relative flex items-center justify-center overflow-hidden lg:overflow-visible flex-shrink-0">
          ...
          <div className="absolute top-[5%] lg:top-[2%] right-[2%] w-32 sm:w-56 lg:w-80 bg-[#fdfbf7] p-2 sm:p-3 lg:p-4 pb-8 sm:pb-12 lg:pb-16 shadow-[0_15px_30px_rgba(0,0,0,0.15)] rounded-sm rotate-[6deg] z-20 border border-[#e5dfd5]">
            {/* Tape */}
            <div className="absolute -top-2 lg:-top-3 left-1/2 -translate-x-1/2 w-8 lg:w-14 h-3 lg:h-6 bg-[#f4ead5]/80 backdrop-blur-sm -rotate-3 shadow-[0_1px_3px_rgba(0,0,0,0.1)]"></div>
            ...
            <div className="absolute bottom-1 lg:bottom-3 left-1/2 -translate-x-1/2 font-handwriting text-lg sm:text-2xl lg:text-3xl text-[#3b342e] whitespace-nowrap -rotate-2">
              Good Vibes
            </div>
          </div>

          {/* POLAROID 2: Sunset Couple (Center/Front) */}
          <div className="absolute top-[18%] lg:top-[22%] left-[8%] lg:left-[10%] w-[220px] sm:w-[320px] lg:w-[500px] bg-[#fdfbf7] p-2 sm:p-4 lg:p-6 pb-12 sm:pb-16 lg:pb-24 shadow-[0_25px_50px_rgba(0,0,0,0.25)] rounded-sm -rotate-[5deg] z-30 border border-[#e5dfd5]">
            {/* Tape */}
            <div className="absolute -top-3 lg:-top-4 left-4 lg:left-8 w-12 lg:w-20 h-5 lg:h-10 bg-[#f4ead5]/90 backdrop-blur-sm rotate-6 shadow-[0_1px_3px_rgba(0,0,0,0.1)]"></div>
            ...
            <div className="absolute bottom-2 lg:bottom-6 left-1/2 -translate-x-1/2 font-handwriting text-xl sm:text-3xl lg:text-5xl text-[#3b342e] whitespace-nowrap -rotate-3">
              Together Always ♡
            </div>
          </div>

          {/* POLAROID 3: Dog (Bottom Right) */}
          <div className="absolute bottom-[8%] lg:bottom-[4%] right-[2%] lg:right-[5%] w-36 sm:w-64 lg:w-96 bg-[#fdfbf7] p-2 sm:p-3 lg:p-4 pb-8 sm:pb-14 lg:pb-20 shadow-[0_20px_40px_rgba(0,0,0,0.18)] rounded-sm rotate-[10deg] z-20 border border-[#e5dfd5]">
             {/* Tape */}
             <div className="absolute top-1 lg:top-2 -right-2 lg:-right-4 w-6 lg:w-12 h-3 lg:h-6 bg-[#f4ead5]/80 backdrop-blur-sm -rotate-45 shadow-[0_1px_3px_rgba(0,0,0,0.1)]"></div>
            ...
            <div className="absolute bottom-1 lg:bottom-4 left-1/2 -translate-x-1/2 font-handwriting text-lg sm:text-2xl lg:text-3xl text-[#3b342e] whitespace-nowrap -rotate-1">
              Furry Happiness ♡
            </div>
          </div>
